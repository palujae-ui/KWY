...
export const policyActivities: PolicyActivity[] = [
  {
    ...
    sources: [
      ...
      {
        label: "금융위원회 공식 블로그 — 보도자료 전문",
        url: "https://blog.naver.com/blogfsc/224246663757",
      },
    ],
  },
  {
    ...
    sources: [{ label: "유경원 교수 이력서 (2026.07)" }],
  },
];
 ...
 * 내일신문 외 매체 기고.
 *
 * columns 는 관리자 화면(Supabase)에서 관리하므로 코드에서 바꿔도 DB 값이 우선한다.
 * 여기 있는 항목은 페이지에서 columns 와 합쳐 URL 기준으로 중복 제거한다.
 * 관리자 화면에 같은 글을 등록하면 이 목록에서 지워도 된다.
 */
export const extraColumns: Column[] = [
  {
    title: "사회 통합의 첫걸음 ‘장기 연체자 지원’",
    outlet: "서울경제 「사외칼럼」",
    date: "2025.07.01",
    url: "https://www.sedaily.com/article/14085655",
  },
];
